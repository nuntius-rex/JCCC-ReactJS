...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 28, 2016 at 08:15 PM
...
(298, 'Vida Sport, Ltd', 'Holz', 'Michael ', '0897-034555', 'Grenzacherweg 237', NULL, 'Gen?ve', NULL, '1203', 'Switzerland', 1702, 141300),
...
(448, 'Scandinavian Gift Ideas', 'Larsson', 'Maria ', '0695-34 6555', '?kergatan 24', NULL, 'Br?cke', NULL, 'S-844 67', 'Sweden', 1504, 116400),
...
ALTER TABLE `employees`
 ADD PRIMARY KEY (`employeeNumber`), ADD KEY `officeCode` (`officeCode`), ADD KEY `reportsTo` (`reportsTo`);
...
ADD CONSTRAINT `employees_ibfk_2` FOREIGN KEY (`reportsTo`) REFERENCES `employees` (`employeeNumber`);
